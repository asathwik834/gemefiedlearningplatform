...
import { ArrowLeft, CheckCircle, Divide, Timer, XCircle } from "lucide-react";
import { useTranslation } from "../../hooks/useTranslation";
const QUESTIONS = [
  { id: 1, q: "48 \xF7 6 = ?", options: ["6", "7", "8", "9"], correct: 2 },
  { id: 2, q: "72 \xF7 8 = ?", options: ["7", "8", "9", "10"], correct: 1 },
  { id: 3, q: "45 \xF7 5 = ?", options: ["7", "8", "9", "10"], correct: 2 },
  { id: 4, q: "64 \xF7 4 = ?", options: ["12", "14", "16", "18"], correct: 2 },
  { id: 5, q: "Remainder of 50 \xF7 6", options: ["2", "3", "4", "5"], correct: 1 },
  { id: 6, q: "84 \xF7 7 = ?", options: ["10", "11", "12", "13"], correct: 2 }
];
const DivisionDash = ({ onBack, currentUser }) => {
  ...
  const handleSubmitScore = async () => {
    try {
      ...
      await rewards.recordHighScore("division-dash", scoreVal, { title: "Division Dash", subject: "Mathematics" });
      setSubmitted(true);
    } catch (err) {
