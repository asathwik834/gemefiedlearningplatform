...
const QUESTIONS = [
  { id: 1, q: "Mirror formula is", options: ["1/f = 1/v + 1/u", "f = u + v", "v = fu", "m = v + u"], correct: 0 },
  { id: 2, q: "Magnification m for mirrors equals", options: ["h/u", "h/v", "v/u", "u/v"], correct: 2 },
  { id: 3, q: "For a concave mirror forming a real image, the image is usually", options: ["Inverted", "Upright", "Same size", "Virtual"], correct: 0 },
  { id: 4, q: "Lens formula is", options: ["1/f = 1/v - 1/u", "f = uv", "1/f = 1/v + 1/u", "v = u + f"], correct: 2 },
  { id: 5, q: "Refractive index n equals", options: ["sin i / sin r", "sin r / sin i", "i/r", "r/i"], correct: 0 },
  { id: 6, q: "A convex lens typically forms a real image when object is", options: ["At infinity", "Between F and 2F", "Closer than F", "At F"], correct: 1 },
  { id: 7, q: "If u = -20 cm, v = 20 cm for a lens, magnification m =", options: ["1", "-1", "2", "-2"], correct: 1 },
  { id: 8, q: "For small angles in radians, sin \u03B8 \u2248", options: ["\u03B8", "\u03B8^2", "1/\u03B8", "0"], correct: 0 },
  { id: 9, q: "Total internal reflection occurs when light travels from", options: ["Rarer to denser medium", "Denser to rarer medium with i > critical", "Any medium to air always", "Vacuum to glass always"], correct: 1 },
  { id: 10, q: "Power of lens (in diopters) equals", options: ["1/f (m)", "f (cm)", "f (m)", "1/f (cm)"], correct: 0 }
];
const LightOptics10 = ({ onBack, currentUser }) => {
  ...
  const handleSubmitScore = async () => {
    try {
      ...
      await rewards.recordHighScore("light-optics10", scoreVal, { title: "Light Optics10", subject: "Physics" });
      setSubmitted(true);
    } catch (err) {
