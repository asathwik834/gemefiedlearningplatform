...
const PALETTE = ["triangle", "square", "rectangle", "pentagon"];
const pretty = (s) => s.charAt(0).toUpperCase() + s.slice(1);
const quizFor = (shape) => {
  switch (shape) {
    case "triangle":
      return { q: "Sum of interior angles of a triangle?", a: "180" };
    case "square":
      return { q: "Perimeter of a square with side 5?", a: "20" };
    case "rectangle":
      return { q: "Area of rectangle 4\xD77?", a: "28" };
    case "pentagon":
      return { q: "Interior angle sum of a pentagon?", a: "540" };
  }
};
const GeometryBuilder8 = ({ onBack, currentUser }) => {
  ...
  const handleSubmitScore = async () => {
    try {
      ...
      await rewards.recordHighScore("geometry-builder8", scoreVal, { title: "Geometry Builder8", subject: "Mathematics" });
      setSubmitted(true);
    } catch (err) {
...
export default GeometryBuilder8;
