...
const QUESTIONS = [
  { id: 1, q: "Which organ pumps blood through the body?", options: ["Lungs", "Heart", "Liver", "Kidney"], correct: 1 },
  { id: 2, q: "Plants make food in the", options: ["Roots", "Stem", "Leaves", "Flowers"], correct: 2 },
  { id: 3, q: "Cell powerhouse is the", options: ["Ribosome", "Nucleus", "Mitochondria", "Chloroplast"], correct: 2 },
  { id: 4, q: "Gas absorbed by plants for photosynthesis", options: ["Oxygen", "Nitrogen", "Carbon Dioxide", "Hydrogen"], correct: 2 },
  { id: 5, q: "Red blood cells carry", options: ["Water", "Oxygen", "Starch", "Fat"], correct: 1 }
];
const BiologyQuest8 = ({ onBack, currentUser }) => {
  ...
  const handleSubmitScore = async () => {
    try {
      ...
      await rewards.recordHighScore("biology-quest8", scoreVal, { title: "Biology Quest8", subject: "Biology" });
      setSubmitted(true);
    } catch (err) {
