...
const QUESTIONS = [
  { id: 1, q: "Pythagoras: In right triangle, c^2 =", options: ["a^2 + b^2", "a^2 - b^2", "2ab", "a/b"], correct: 0 },
  { id: 2, q: "If two triangles are similar, then their areas are in ratio of", options: ["Sides", "Squares of corresponding sides", "Heights", "Angles"], correct: 1 },
  { id: 3, q: "In triangle, sum of interior angles is", options: ["90\xB0", "120\xB0", "180\xB0", "360\xB0"], correct: 2 },
  { id: 4, q: "Right triangle with legs 6 and 8; hypotenuse is", options: ["9", "10", "11", "12"], correct: 1 },
  { id: 5, q: "If two angles equal in a triangle, triangle is", options: ["Isosceles", "Scalene", "Right", "Equilateral"], correct: 0 }
];
const GeometryTheorems9 = ({ onBack, currentUser }) => {
  ...
  const handleSubmitScore = async () => {
    try {
      ...
      await rewards.recordHighScore("geometry-theorems9", scoreVal, { title: "Geometry Theorems9", subject: "Mathematics" });
      setSubmitted(true);
    } catch (err) {
...
export default GeometryTheorems9;
